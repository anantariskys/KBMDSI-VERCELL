...
const SectionAnggotaDepartemen = ({ dataAnggota }) => {
    ...
    return (
        <section className="bg-[#E28858] pt-40 md:pt-60 lg:pt-80 pb-20 relative overflow-hidden">
            <img
                src={wave}
                alt={wave}
                className="absolute z-10 top-0 -translate-y-[31%] w-full aspect-auto"
                draggable="false"
            />
            <div className="container mx-auto text-slate-50">
                ...
                <div className="container mx-auto flex w-full flex-wrap justify-center gap-x-24 gap-y-48 md:px-8">
                    {dataAnggota.anggota[0].badanPengurusHarian.map(
                        (anggota) => (
                ...
                <div className="container mx-auto flex w-full flex-wrap justify-center gap-x-24 gap-y-48 md:px-8">
                    {dataAnggota.anggota[0].staffAhli.map((anggota) => (
                        <AnggotaCard key={anggota.id} data={anggota} />
                    ))}
                </div>
            </div>
            ...
            <CircleBackground className="hidden md:block absolute top-[79%] -right-[20%] w-[280px] h-[280px] bg-[#D56C3A] rounded-full" />
            ...
            <CircleBackground className="hidden md:block absolute top-[88%] right-[20%] w-[280px] h-[280px] bg-[#D56C3A] rounded-full" />
            ...
            <CircleBackground className="hidden md:block absolute top-[100%] right-[8%] w-[95px] h-[95px] bg-[#D56C3A] rounded-full" />
        </section>
    );
};

export default SectionAnggotaDepartemen;
