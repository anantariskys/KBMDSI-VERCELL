...
const SectionAnggotaKomisi = ({ dataAnggota }) => {
    ...
    return (
        <section className="bg-[#E28858] pt-40 md:pt-60 lg:pt-80 pb-20 relative overflow-hidden">
            <img
                src={wave}
                alt={wave}
                className="absolute z-10 -top-[2%] md:-top-[6%] lg:-top-[11%] w-full aspect-auto"
                draggable="false"
            />
            <div className="container mx-auto text-slate-50">
                ...
                <div className="container mx-auto flex w-full flex-wrap justify-center gap-x-24 gap-y-48 md:px-8">
                    {dataAnggota.anggota[0].koordinator.map((anggota) => (
            ...
            <img
                src={textile}
                alt={textile}
                className="absolute top-[20%] left-0 w-48"
                draggable="false"
            />
            ...
            <CircleBackground className="hidden md:block absolute top-[26%] right-[6%] w-[280px] h-[280px] bg-[#D56C3A] rounded-full" />
...
export default SectionAnggotaKomisi;
